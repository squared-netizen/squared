# Squared Graphics Package Agent Instructions
...
Defines portable low-level graphics contracts and value types without selecting a platform backend.
...
- root programmer page: `docs/programmer/squared-graphics/README.md`;
- root developer page: `docs/developer/squared-graphics/README.md`.
...
Document `Color`, graphics context capabilities and lifecycle contracts, units, channel ranges, conversions, ownership, errors, and backend-neutral examples.
...
Document portable/backend boundary, value representation, context invariants, compile-time separation, and why runtime backend registration is avoided.
...
No SDL, OpenGL, Android, or GUI includes are permitted in public portable headers.
...
`docs/developer/squared-graphics/` for:

- portable Graphics contract to selected backend;
...
Run `squared_graphics_test` and the portable-header compilation boundary test.
