...
public:
     ...
     */
    [[nodiscard]] const sq::math::Matrix4& combined() const noexcept;

    /**
     * @brief Read the camera center.
     * @return Center position in logical coordinates.
     */
    [[nodiscard]] sq::math::Vector2 position() const noexcept;
...
private:
    ...
    sq::math::Vector2 position_;
    float zoom_{1.0F};
    CoordinateOrigin origin_;
    sq::math::Matrix4 combined_;
};
