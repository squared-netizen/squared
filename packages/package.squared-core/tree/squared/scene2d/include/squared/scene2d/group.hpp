...
public:
    /** @brief Identifier published for actor_cast<Group>(). */
    static constexpr ActorInterfaceId actor_interface_id = 0x47'52'50'01U;

    Group() = default;
    ~Group() override;

    /**
     * @brief Publish the Group interface to actor_cast().
     * @param id Identifier of the requested interface.
     * @return This group for the Group identifier, otherwise the base answer.
     */
    ...
    /**
     * @brief Publish the Group interface to actor_cast(), read-only.
     * @param id Identifier of the requested interface.
     * @return This group for the Group identifier, otherwise the base answer.
     */
